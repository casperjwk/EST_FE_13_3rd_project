    ...
    <header className={styles["common-header"]}>
      <div className={`container ${styles["common-header__inner"]}`}>
        ...
        <nav className={styles["common-header__nav"]}>
          <Link to="/" className={`${styles["common-header__nav-link"]} text-s`}>
            홈
          </Link>
          <Link to="/recipes" className={`${styles["common-header__nav-link"]} text-s`}>
            레시피
          </Link>
          <Link to="/mypage" className={`${styles["common-header__nav-link"]} text-s`}>
            마이페이지
          </Link>
        </nav>
        ...
        <div className={styles["common-header__auth-area"]}>
          {isLoggedIn ? (
            ...
            <>
              <Link to="/login" className={`${styles["common-header__login-btn"]} text-button-s`}>
                로그인
              </Link>
              <Link to="/signup" className={`${styles["common-header__signup-btn"]} text-button-s`}>
                회원가입
              </Link>
            </>
          )}
        ...
        <div className={styles["common-header__mobile-menu"]}>
          {isLoggedIn ? (
            <>
              ...
              <Link to="/recipes" className={`${styles["common-header__mobile-link"]} text-s`} onClick={closeMenu}>
                레시피
              </Link>
              <Link to="/mypage" className={`${styles["common-header__mobile-link"]} text-s`} onClick={closeMenu}>
                마이페이지
              </Link>
              <Link to="/favorite" className={`${styles["common-header__mobile-link"]} text-s`} onClick={closeMenu}>
                즐겨찾기
              </Link>
              <button className={`${styles["common-header__logout-btn"]} text-s`} onClick={handleLogout}>
                로그아웃
              </button>
            </>
          ) : (
            <>
              ...
              <div className={styles["common-header__mobile-auth-btns"]}>
                <Link to="/login" className={`${styles["common-header__login-btn"]} text-button-s`} onClick={closeMenu}>
                  로그인
                </Link>
                <Link
                  to="/signup"
                  className={`${styles["common-header__signup-btn"]} text-button-s`}
                  onClick={closeMenu}
                >
                  회원가입
                </Link>
